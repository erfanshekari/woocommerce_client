...
class ShopCoupon1 {
  /// Returns a new [ShopCoupon1] instance.
  ShopCoupon1({
    this.code,
    this.amount,
    this.discountType,
  ...
  ShopCoupon1DiscountTypeEnum? discountType;
  ...
  @override
  String toString() =>
      'ShopCoupon1[code=$code, amount=$amount, discountType=$discountType, description=$description, dateExpires=$dateExpires, dateExpiresGmt=$dateExpiresGmt, individualUse=$individualUse, productIds=$productIds, excludedProductIds=$excludedProductIds, usageLimit=$usageLimit, usageLimitPerUser=$usageLimitPerUser, limitUsageToXItems=$limitUsageToXItems, freeShipping=$freeShipping, productCategories=$productCategories, excludedProductCategories=$excludedProductCategories, excludeSaleItems=$excludeSaleItems, minimumAmount=$minimumAmount, maximumAmount=$maximumAmount, emailRestrictions=$emailRestrictions, metaData=$metaData]';
  ...
  /// Returns a new [ShopCoupon1] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShopCoupon1? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ShopCoupon1[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ShopCoupon1[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ShopCoupon1(
        ...
        discountType:
            ShopCoupon1DiscountTypeEnum.fromJson(json[r'discount_type']),
  ...
  static List<ShopCoupon1> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ShopCoupon1>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShopCoupon1.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShopCoupon1> mapFromJson(dynamic json) {
    final map = <String, ShopCoupon1>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShopCoupon1.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShopCoupon1-objects as value to a dart map
  static Map<String, List<ShopCoupon1>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<ShopCoupon1>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShopCoupon1.listFromJson(
          entry.value,
          growable: growable,
        );
      }
...
/// Determines the type of discount that will be applied.
class ShopCoupon1DiscountTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const ShopCoupon1DiscountTypeEnum._(this.value);
  ...
  static const percent = ShopCoupon1DiscountTypeEnum._(r'percent');
  static const fixedCart = ShopCoupon1DiscountTypeEnum._(r'fixed_cart');
  static const fixedProduct = ShopCoupon1DiscountTypeEnum._(r'fixed_product');

  /// List of all possible values in this [enum][ShopCoupon1DiscountTypeEnum].
  static const values = <ShopCoupon1DiscountTypeEnum>[
    percent,
    fixedCart,
    fixedProduct,
  ];

  static ShopCoupon1DiscountTypeEnum? fromJson(dynamic value) =>
      ShopCoupon1DiscountTypeEnumTypeTransformer().decode(value);

  static List<ShopCoupon1DiscountTypeEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ShopCoupon1DiscountTypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShopCoupon1DiscountTypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ShopCoupon1DiscountTypeEnum] to String,
/// and [decode] dynamic data back to [ShopCoupon1DiscountTypeEnum].
class ShopCoupon1DiscountTypeEnumTypeTransformer {
  factory ShopCoupon1DiscountTypeEnumTypeTransformer() =>
      _instance ??= const ShopCoupon1DiscountTypeEnumTypeTransformer._();

  const ShopCoupon1DiscountTypeEnumTypeTransformer._();

  String encode(ShopCoupon1DiscountTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ShopCoupon1DiscountTypeEnum.
  ///
  ...
  ShopCoupon1DiscountTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'percent':
          return ShopCoupon1DiscountTypeEnum.percent;
        case r'fixed_cart':
          return ShopCoupon1DiscountTypeEnum.fixedCart;
        case r'fixed_product':
          return ShopCoupon1DiscountTypeEnum.fixedProduct;
        default:
          if (!allowNull) {
  ...
  /// Singleton [ShopCoupon1DiscountTypeEnumTypeTransformer] instance.
  static ShopCoupon1DiscountTypeEnumTypeTransformer? _instance;
}
